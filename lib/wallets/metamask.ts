            ...
            params: [
              {
                ...
                nativeCurrency: {
                  name: provider.coinSymbol,
                  decimals: provider.decimals,
                  coinSymbol: provider.coinSymbol,
                },
...
*/
  ...
  */
  ...
  async getBalance(adr: string) {
    ...
    const balance = await this.metamask.request({
  ...
  async getGasPrice() {
    let gas = await this.metamask.request({
      method: 'eth_gasPrice',
      params: [],
    });
  ...
  async getTransactionInfo(txid: string) {
    let info = await this.metamask.request({
